...
var Inflection, Language, Orthography, PhraseStructure, Word;
...
Inflection = (function() {
  ...
  Inflection.prototype.inflect = function(word, form) {
    var condition, expandedCondition, group, groupRegexp, groups, inflection, inflector, letters, match, re, root, trimOff, _i, _len;
    inflector = "default";
    root = word.lemma;
